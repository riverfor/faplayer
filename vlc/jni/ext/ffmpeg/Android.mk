...
FF_AVCODEC_ARM_VFP_SRC := \
    libavcodec/arm/dsputil_vfp.S \
    libavcodec/arm/dsputil_init_vfp.c \
    libavcodec/arm/fmtconvert_vfp.S

FF_AVCODEC_ARM_NEON_SRC := \
...
ifeq ($(BUILD_WITH_ARM_NEON),)
BUILD_WITH_ARM_NEON := 0
endif
ifeq ($(BUILD_WITH_ARM_VFPV3D16),)
BUILD_WITH_ARM_VFPV3D16 := 0
endif
ifeq ($(BUILD_WITH_ARM_VFP),)
BUILD_WITH_ARM_VFP := 0
endif
...
ifeq ($(BUILD_WITH_ARM_VFPV3D16),1)
BUILD_WITH_ARM_VFP := 1
endif
ifeq ($(BUILD_WITH_ARM_VFP),1)
BUILD_WITH_ARM_NEON := 0
endif
...
FF_CFLAGS += \
    ...
    -DHAVE_ARMV6=1 \
    -DHAVE_ARMV6T2=1 \
    -DHAVE_ARMVFP=$(BUILD_WITH_ARM_VFP) \
    -DHAVE_NEON=$(BUILD_WITH_ARM_NEON) \
    -DHAVE_IWMMXT=0
else
FF_CFLAGS += \
    -DHAVE_ARMV5TE=0 \
...
ifeq ($(BUILD_WITH_ARM),1)
LOCAL_SRC_FILES += $(FF_AVCODEC_ARM_SRC)
ifeq ($(BUILD_WITH_ARM_VFP),1)
LOCAL_SRC_FILES += $(FF_AVCODEC_ARM_VFP_SRC)
endif
ifeq ($(BUILD_WITH_ARM_NEON),1)
LOCAL_SRC_FILES += $(FF_AVCODEC_ARM_NEON_SRC)
endif
endif
